...
public class AdminController {
	...
	//private String path = "C:\\myspace\\workspace\\ShoppingCartFrontEnd\\src\\main\\resources\\image";

	@RequestMapping("/addcategory")
	public String Addcategory(Model model, HttpSession session, @ModelAttribute("id") String id,
	...
	public String Addproduct(Model model, HttpSession session, @ModelAttribute("id") String id,
