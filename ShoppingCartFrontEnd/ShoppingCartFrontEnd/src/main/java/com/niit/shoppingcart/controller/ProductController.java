...
public class ProductController {
	...
	public String Editproduct(Model model, HttpSession session, @ModelAttribute("id") String id,
			@ModelAttribute("name") String name, @ModelAttribute("price") int price, @ModelAttribute("stock") int stock,
	...
	public ModelAndView displayProduct(@RequestParam(value = "categoryId") String categoryId,
		...
		if(productList != null) {
			...
			mv.addObject("successMsg", "No products found for this category !!!");
		}
