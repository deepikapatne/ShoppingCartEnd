...
public class OrderWebflow implements Serializable {
	...
	public String addShippingAddress(Order orders, ShippingAddress shippingAddress) {
	...
	public String addBillingAddress(Order Orders, BillingAddress billingAddress) {
	...
	public String addPaymentMethod(Order orders, PaymentMethod paymentMethod) {
	...
	public String confirmOrder(Order orders) {
